...
function Profile() {
  const { profile, updateAvatar, removeAvatar, forgotPassword } = useAuth();
  ...
  const handleSendPasswordReset = async () => {
    ...
    const { error } = await forgotPassword(profile.email);
  ...
  return (
    <div className="max-w-md">
      ...
      <div className="space-y-6">
        ...
        <div className="pt-5 mt-10 border-t border-gray-300">
          <h2 className="font-medium">Change Password</h2>
          <p className="text-sm text-gray-600 mb-4">
            Send yourself a secure password reset link by email.
          </p>
          <Button
            type="button"
